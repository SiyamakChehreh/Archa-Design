...
import { useGetAllStudentsByCourseQuery } from "../store/index";
...
export const CourseStudentsModal: React.FC<ModalProps> = ({
  isCourseOpen,
  onClose,
  courseId,
}) => {
  if (!isCourseOpen) return null;

  const { data: students, isLoading } =
    useGetAllStudentsByCourseQuery(courseId);

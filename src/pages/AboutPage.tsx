...
export default function AboutPage() {
  return (
    <section id="about" className="bg-gray-200">
      <div className="py-4">
        <div className="flex flex-col gap-20 basis-auto overflow-hidden overflow-y-auto md:flex md:flex-row mx-auto my-auto justify-around items-center h-screen bg-gray-200 perspective-normal">

...
export default function ArchitectsPage() {
  return (
    <section className="h-auto w-screen scroll-mt-30" id="architects">
      <div className="flex flex-col h-auto w-screen gap-10 lg:gap-10 bg-gray-200">
        ...
        <div className="h-auto lg:h-auto mx-auto w-screen ">
          <div className="h-auto lg:h-auto mx-auto w-screen bg-gray-200 flex flex-row flex-wrap overflow-visible items-end justify-center gap-10 lg:gap-25 lg:pl-18 pt-15">

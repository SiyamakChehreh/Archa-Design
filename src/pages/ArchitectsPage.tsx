      ...
      <div className="flex flex-col h-auto w-screen gap-20 lg:gap-10 bg-gray-200">
        <div className="group h-45 lg:h-75 gap-5 lg:gap-15 w-auto bg-gray-200 flex flex-col lg:flex-row justify-center items-center perspective-normal">
          ...
          <div className="h-25 w-60 lg:h-60 lg:w-170 animate-rotate-border bg-conic/[from_var(--border-angle)] from-stone-300 via-amber-400 to-stone-300 rounded-xl relative shadow-2xl">
            <div className="flex flex-col h-23 w-59 lg:h-58 lg:w-168 bg-amber-50 rounded-lg lg:gap-5 px-2 py-1 absolute top-1 left-1 scale-[0.97] hover:scale-[1.00] transition-all duration-700 shadow-2xl">
              <h1 className="font-lalezar font-bold text-center text-sm lg:text-2xl pt-0 lg:pt-2">
                روح الله احمدی
              </h1>
              <h1 className="font-lalezar text-center font-bold text-sm lg:text-lg">
                مدیر عامل شرکت آرکا دیزاین
              </h1>
              <p className="font-lalezar text-center text-xs lg:text-lg">
        ...
        <div className="h-74 lg:h-104 mx-auto w-screen ">
          <div className="h-auto lg:h-104 mx-auto w-screen bg-gray-200 flex flex-row flex-wrap overflow-visible items-end justify-center gap-10 lg:gap-25 lg:pl-18 pt-15">
            <div className="group h-50 w-40 lg:h-70 lg:w-60 mb-4 lg:mb-10 border-10 border-fuchsia-100 rounded-lg bg-stone-300 relative perspective-normal opacity-60 hover:opacity-100 hover:scale-[1.1] transition-all duration-800 drop-shadow-2xl">
              ...
              <div className="flex flex-col mt-9 lg:mt-18 mr-2">
                <h1 className="text-right font-lalezar text-lg lg:text-2xl">
                  محسن مخملباف
                </h1>
                <h1 className="text-right font-lalezar text-lg lg:text-xl my-1 mr-2">
                  طراح سه بعدی
                </h1>
                <p className="text-center font-lalezar text-xs lg:text-lg">
